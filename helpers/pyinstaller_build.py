...
def build_app(a_main_filename: str, a_app_info: AppInfo = None, a_icon_filename: str = "", a_noconsole=True,
    ...
    """
    if a_app_info is None:
        a_app_info = AppInfo("some_python_app")

    name = f" -n {a_app_info.app_name}"
...
def build_qt_app(a_main_filename: str, a_app_info: AppInfo, a_icon_filename: str = "", a_noconsole=True,
    ...
    tmp_filename = f"{a_app_info.app_name}.py"
