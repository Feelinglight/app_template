...
class Ui_about_dialog(object):
    ...
    def retranslateUi(self, about_dialog):
        ...
        self.label_2.setText(_translate("about_dialog", "Шаблон приложения для статьй на хабре"))
        self.version_label.setText(_translate("about_dialog", "Версия программы: "))
        self.label_3.setText(_translate("about_dialog", "app_template"))
